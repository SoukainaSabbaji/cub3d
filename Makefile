...
#    Updated: 2023/03/05 11:30:37 by makacem          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SOURCES_LIST = parsing.c main.c lodev.c drawing.c helper.c ft_check_input.c \
				...
				ft_check_wall.c ft_getheight.c ft_getwidth.c \
				ft_initrays.c ft_putcolor.c ft_putgrid.c \
				ft_putmap.c ft_putplayer.c ft_putray.c \
				my_minimapkeyhook.c \
