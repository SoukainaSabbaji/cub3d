...
#    Updated: 2023/03/12 11:08:51 by ssabbaji         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SOURCES_LIST = main.c drawing.c hooks.c helper.c \
			   init_calc_vars.c vector_utils.c coord_utils.c texture_handling.c \
			   perform_dda.c initialize_game_vars.c start_game.c handle_rotation.c\
